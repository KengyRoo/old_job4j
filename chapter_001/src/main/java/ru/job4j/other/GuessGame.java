...
public class GuessGame {
    //GuessGame содержит три переменных экземпляра для трех обьектов Player
    Player p1;
    Player p2;
    Player p3;

    //Создаем три объекта Player и присваиваем их трем переменным экземляра
    public void startGame(){
        ...
        //Объявляем три переменные хранения правильности или неправильности (true или false) ответов игроков.
        boolean p1isRight = false;
        boolean p2isRight = false;
        boolean p3isRight = false;

        //Создаем число, которое игроки должны угудать.
        ...
        while (true){
            ...
            //Вызываем guess()из каждого объекта Player
            p1.guess();
            p2.guess();
            p3.guess();
            ...
            //Если игрок угадал, то присваиваем соответствующей переменной значение true(помните, что по умолчанию false)
            ...
            //Если первый игрок, ИЛИ второй игрок, ИЛИЛ третий игрок угадал (оператор || означает ИЛИ)...
